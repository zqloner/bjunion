...
public class ShiroUtils
{
    ...
    public static EnterpriseEnterprise getSysUser()
    {
        EnterpriseEnterprise user = null;
        Object obj = getSubjct().getPrincipal();
        if (obj != null)
        {
            user = new EnterpriseEnterprise();
            BeanUtils.copyBeanProp(user, obj);
        }
        return user;
    }

    public static void setSysUser(EnterpriseEnterprise user)
    {
